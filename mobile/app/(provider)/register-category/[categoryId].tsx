    ...
    <>
      <ScrollView style={{ flex: 1, backgroundColor: '#FFFFFF' }} contentContainerStyle={{ padding: 26, paddingTop: 60, paddingBottom: 100 }}>
        ...
        <Field label="Nomor Telepon">
          <TextInput style={styles.input} value={noTelp} onChangeText={setNoTelp} keyboardType="phone-pad" />
        </Field>

        <Field label="Gender">
          <Pressable style={styles.select} onPress={() => openSelectModal('Pilih Gender', [{ id: 'Laki-laki', name: 'Laki-laki' }, { id: 'Perempuan', name: 'Perempuan' }], (g) => setGender(g.id))}>
             <Text>{gender}</Text>
        ...
        <Field label="Alamat Email">
          <TextInput style={styles.input} value={email} onChangeText={setEmail} keyboardType="email-address" autoCapitalize="none" placeholder="Masukkan email" />
        </Field>
